                ...
                public void onCallStateChanged(int state, String phoneNumber) {
                    ...
                    switch (state) {
                        case TelephonyManager.CALL_STATE_IDLE:
                            callbackContext.sendPluginResult(new PluginResult(PluginResult.Status.OK, TelephonyManager.CALL_STATE_IDLE));
                            break;
                        case TelephonyManager.CALL_STATE_OFFHOOK:
                            callbackContext.sendPluginResult(new PluginResult(PluginResult.Status.OK, TelephonyManager.CALL_STATE_OFFHOOK));
                            break;
                    }
                }
